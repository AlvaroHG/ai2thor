...
@task
def benchmark(ctx, screen_width=600, screen_height=600, editor_mode=False, out='benchmark.json', verbose=False):
    import ai2thor.controller
    import random
    import time
    import json
    ...
    env = ai2thor.controller.Controller()
    if editor_mode:
        env.start(8200, False, player_screen_width=screen_width, player_screen_height=screen_height)
    else:
